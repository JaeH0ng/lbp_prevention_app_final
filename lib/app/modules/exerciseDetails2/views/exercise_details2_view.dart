...
class ExerciseDetails2View extends GetView<ExerciseDetails2Controller> {
  const ExerciseDetails2View({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      backgroundColor: Colors.grey[200],
      body: GetBuilder(
        init: ExerciseDetails2Controller(),
        builder: (context) {
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    controller.actionExerciseList[index]
                                        .sets ==
                                        null
                                        ? ''
                            ...
                            CircularCountDownTimer(
                              ...
                              height: MediaQuery.of(context).size.height *
                                  0.15,
                              duration: controller
                                  .actionExerciseList[index].actingTime,
